/* Documentation-Pages rspack config */
  ...
  return merge(getProdCommonConfig(), getCommonConfig(), {
    ...
    plugins: [
      new rspack.container.ModuleFederationPlugin({
        ...
        remotes: getAppModuleFederationConfig(Apps['documentation-pages']).remotes?.prod
      }),
      ...(env.analyze ? [getBundleAnalyzerPlugin(Apps['documentation-pages'])] : [])
    ]
  });
};
